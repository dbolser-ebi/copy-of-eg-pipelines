...
package Bio::EnsEMBL::EGPipeline::Exonerate::ExonerateAlignFeature;
...
sub fetch_runnable {
  ...
  # Exonerate runs about eleventy-gazillion times faster if you
  # run a server off an index file, even without threading.
  my $port = $self->start_server();
  
  $parameters{'TARGET_FILE'} = "localhost:$port";
