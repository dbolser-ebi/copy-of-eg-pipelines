...
Bio::EnsEMBL::EGPipeline::PipeConfig::LoadGFF3Batch_conf
...
package Bio::EnsEMBL::EGPipeline::PipeConfig::LoadGFF3Batch_conf;

use strict;
use warnings;

use base ('Bio::EnsEMBL::EGPipeline::PipeConfig::LoadGFF3_conf');
...
sub pipeline_analyses {
  ...
  return [
...

    {
      ...
      -module          => 'Bio::EnsEMBL::EGPipeline::LoadGFF3::ConstructFilenames',
      -max_retry_count => 0,
      -parameters      => {
