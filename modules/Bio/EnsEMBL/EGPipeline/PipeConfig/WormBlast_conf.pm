...
package Bio::EnsEMBL::EGPipeline::PipeConfig::WormBlast_conf;
    ...
    [
      {
        ...
        'db'            => 'gadfly',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/gadfly90.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        ...
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/gadfly90.pep',
      },
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'yeast',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/yeast63.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'slimswissprot',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/slimswissprot20166.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/slimswissprot20166.pep',
      },
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'ipi_human',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/ipi_human_07_20.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'wormpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/wormpep255.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/wormpep255.pep',
      },
      {                 
        'logic_name'    => 'wormpepx',
        'display_label' => $self->o('source_label'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'remapep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/remapep250.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/remapep250.pep',
      },
      {                 
        'logic_name'    => 'remapepx',
        'display_label' => $self->o('source_label'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'ppapep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/ppapep250.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'jappep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/jappep250.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'brepep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brepep250.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'brigpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brigpep254.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brigpep254.pep',
      },
      {                 
        'logic_name'    => 'brigpepx',
        'display_label' => $self->o('source_label'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'brugpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brugpep254.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brugpep254.pep',
      },
      {                 
        'logic_name'    => 'brugpepx',
        'display_label' => $self->o('source_label'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'ovolpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/ovolpep253.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
