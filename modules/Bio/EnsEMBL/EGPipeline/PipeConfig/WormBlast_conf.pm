    ...
    [
      {
        ...
        'db'            => 'gadfly',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/gadfly91.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        ...
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/gadfly91.pep',
      },
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'slimswissprot',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/slimswissprot20167.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/slimswissprot20167.pep',
      },
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'wormpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/wormpep256.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/wormpep256.pep',
      },
      {                 
        'logic_name'    => 'wormpepx',
        'display_label' => $self->o('source_label'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'remapep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/remapep256.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
      ...
      },
      {
        ...
        'web_data'      => '{"type" => "protein"}',
        'db'            => 'brigpep',
        'blast_db'      => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brigpep256.pep',
        'db_version'    => '1',
        'program'       => 'blastp',
        'program_file'  => $self->o('blastp_exe'),
        'parameters'    => $self->o('blast_parameters'),
        ...
        'linked_tables' => ['protein_feature'],
        'db_type'       => 'core',
        'db_file'       => '/nfs/nobackup/ensemblgenomes/wormbase/BUILD/pipeline/BlastDB/brigpep256.pep',
      },
      {                 
        'logic_name'    => 'brigpepx',
        'display_label' => $self->o('source_label'),
