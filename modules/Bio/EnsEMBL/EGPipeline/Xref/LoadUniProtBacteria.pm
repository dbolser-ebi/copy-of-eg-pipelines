...
package Bio::EnsEMBL::EGPipeline::Xref::LoadUniProtBacteria;
use base qw/Bio::EnsEMBL::Production::Pipeline::Base/;

use Log::Log4perl qw/:easy/;
use Bio::EnsEMBL::Utils::Exception qw(throw warning);
use Bio::EnsEMBL::DBSQL::DBAdaptor;
use Bio::EnsEMBL::EGPipeline::Xref::BacteriaUniProtLoader;
...
sub run {
  ...
  my $loader =
	Bio::EnsEMBL::EGPipeline::Xref::BacteriaUniProtLoader->new(
