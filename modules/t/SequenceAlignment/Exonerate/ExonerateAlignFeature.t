...
use Bio::EnsEMBL::EGPipeline::SequenceAlignment::Exonerate::ExonerateAlignFeature;
...
my $tmp_dir = "/tmp/$ENV{'USER'}/exoneratealignfeature";
make_path($tmp_dir);
...
my $exonerate_params = '--model affine:local --softmasktarget TRUE --bestn 1 ';

my $module_name    = 'Bio::EnsEMBL::EGPipeline::SequenceAlignment::Exonerate::ExonerateAlignFeature';
my @hive_methods   = qw(param_defaults fetch_input run write_output);
my @module_methods = qw(fetch_runnable filter_output results_by_index);
...
my $obj  = Bio::EnsEMBL::EGPipeline::SequenceAlignment::Exonerate::ExonerateAlignFeature->new;
...
$obj->param('logic_name',  'est_exonerate');
...
is_rows(9, $dba, 'dna_align_feature', 'WHERE analysis_id = ?', [$analysis_id]);
